...
import MyPage from "./HomeComp/ProviderProfile";
...
import {
  ...
  removeSpecificModal,
  addSpecificModal,
} from "../../redux/features/modalUiSlice";
...
const myAllData = [
  {
    key: "1",
    image: "/admin/images/doctor1.svg",
    fName: <span className="font-fam fw-500">John</span>,
    lName: <span className="font-fam fw-500">Brown</span>,
    role: <span className="font-fam fw-500">PA</span>,
  ...
  },
  {
    key: "2",
    image: "/admin/images/doctor1.svg",
    fName: <span className="font-fam fw-500">Michael</span>,
    lName: <span className="font-fam fw-500">Davis</span>,
    role: <span className="font-fam fw-500">DMD</span>,
  ...
  },
  {
    key: "3",
    image: "/admin/images/doctor1.svg",
    fName: <span className="font-fam fw-500">Jessica</span>,
    lName: <span className="font-fam fw-500">Wilson</span>,
    role: <span className="font-fam fw-500">PT</span>,
...
function HomePage({ t, lng }) {
  ...
  const columns = [
    {
      title: <label>{t("layoutprovider.image")}</label>,
      dataIndex: "image",
      key: "image",
      render: (image) => (
        <Image
  ...
  const items = [
    {
      ...
      label: (
        <div className="flex flex-row gap-1 align-items-center">
          <p className="mb-0 text-primary fs-16 font-fam ">All Providers</p>
          <p className="mb-0 fs-16 my-active-style my-non-active-style">
            {myAllData.length}
          </p>
        </div>
      ),
      children: <MyPage t={t} lng={lng} columns={columns} data={myAllData} />,
    },
    {
      key: "2",
      label: (
        <div className="flex flex-row gap-1 align-items-center">
          <p className="mb-0 text-primary fs-16 font-fam">Active Providers</p>
          <p className="mb-0 fs-16 my-active-style my-non-active-style">
      ...
      children: (
        <MyPage t={t} lng={lng} columns={columns} data={activeProviders} />
      ),
    },
    {
      key: "3",
      label: (
        <div className="flex flex-row gap-1 align-items-center">
          <p className="mb-0 text-primary fs-16 font-fam">InActive Providers</p>
          <p className="mb-0 fs-16 my-active-style my-non-active-style">
      ...
      children: (
        <MyPage t={t} lng={lng} columns={columns} data={inActiveProviders} />
      ),
    },
    {
      key: "4",
      label: (
        <div className="flex flex-row gap-1 align-items-center">
          <p className="mb-0 text-primary fs-16 font-fam">Pending Approvals</p>
          <p className="mb-0 fs-16 my-active-style my-non-active-style">
      ...
      children: (
        <MyPage t={t} lng={lng} columns={columns} data={pendingProviders} />
      ),
    },
  ];
        ...
        <AdminRow gutter={[16, 16]}>
          <Col span={24}>
            <div className="p-8 boundary mt-4">
              <div>
                <h2 className="fs-28 font-fam fw-700">Home</h2>
              </div>
              <div
